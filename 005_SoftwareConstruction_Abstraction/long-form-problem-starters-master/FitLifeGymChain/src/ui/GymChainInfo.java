...
public class GymChainInfo {
    ...
    public static final String QUY_BEAUTY_GYM_NAME = "Quy Beauty";
    public static final String QUY_MEMBER_NAME = "Quy";
    ...
    private static void loadMembers(GymChain chain){
        ...
        Member m4 = new Member(QUY_MEMBER_NAME);
    ...
    private static void loadGyms(GymChain chain){
        ...
        Gym g0 = new Gym(QUY_BEAUTY_GYM_NAME);
        //TOD 4: add your new gym's variable name and uncomment:
        initializeGym0(g0);
        chain.addGym(g0);
    }
    ...
    private static void initializeGym0(Gym gym){
         Barbell bar = new Barbell(20); // make a new barbell
         IndoorBike bike = new IndoorBike(); // make a new IndoorBike
         gym.addWeight(bar);
