...
public class BurgerByte {
    ...
    // REQUIRES: e must not be in this staff or this BurgerByte's Manager's team
    // MODIFIES: this
    // EFFECTS: adds the given employee to this staff
    public void addStaff(Employee e) {
        staff.add(e);
    }
    // REQUIRES: e must be in this staff and this BurgerByte's Manager's team
    // MODIFIES: this
    ...
    public void computeStaffWages() {
        for (Employee e : staff) {
            System.out.println("Name: " + e.getName() +", Salar: " + e.computeWage());
        }
