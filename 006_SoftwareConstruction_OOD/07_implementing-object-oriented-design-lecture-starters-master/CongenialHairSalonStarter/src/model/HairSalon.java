...
public class HairSalon {
    ...
    private Map<Treatment, ArrayList<String>> treatmentMap = new HashMap<>();
    ...
    public void suggestConsultant(Treatment treatment) {
        ...
        ArrayList<String> names = treatmentMap.get(treatment);
    ...
    private void addTreatment(Treatment treatment){
        treatmentMap.put(treatment, new ArrayList<>());
    }

    private void addTreatmentSpecialist(Treatment t, String name){
        ArrayList<String> names = treatmentMap.get(t);
        names.add(name);
    }
