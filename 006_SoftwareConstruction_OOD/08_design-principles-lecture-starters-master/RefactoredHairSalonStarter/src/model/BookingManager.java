...
public class BookingManager {
    ...
    public boolean makeNewBooking(Customer c, int bookingTime, Treatment treatment){
        if (verifyBookingTime(bookingTime, treatment)) return false;
        setBookedTime(c, bookingTime, treatment, false);
        c.setBookedTime(bookingTime, treatment);
        return true;
    }

    private void setBookedTime(Customer c, int bookingTime, Treatment treatment, boolean cancel) {
    ...
    private boolean verifyBookingTime(int bookingTime, Treatment treatment) {
    ...
    public boolean cancelBooking(Customer c, int bookingTime, Treatment treatment){
        if (verifyBookingTime(bookingTime, treatment)) return false;
        setBookedTime(c, bookingTime, treatment, true);
