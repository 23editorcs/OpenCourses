...
public class LiveTwitterSource extends TwitterSource {
    ...
    private void initializeTwitterStream() {
        ...
        cb.setOAuthConsumerKey("gCsFMVuQGYEq9ySHIxYeYEMp4")
                .setOAuthConsumerSecret("1YHfnEAXDk4izVR0thRQWagGGLMXSZ9yTibqOKmVl2YPILEizr")
                .setOAuthAccessToken("719772684113080320-0iihqRkpf3ciJutYujWtvHNZTJqEYIp")
                .setOAuthAccessTokenSecret("8RNfhALejWcWK0Tnjh89XNgkTREHpE8DHDsypk1omZHPs");
